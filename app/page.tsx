...
const Home: React.FC = () => {
  ...
  const [location, setLocation] = useState<string>(() => Cookies.get('userCountry'));
    ...
    <>
      ...
      >
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-teal-900 drop-shadow-xl drop-shadow-white tracking-widest uppercase">THE ISLAMIC DATE TODAY IN {location} IS</h1>
        </div>
        <div>
